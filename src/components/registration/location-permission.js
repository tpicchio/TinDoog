...
export function LocationPermission({ onNext, onCancel }) {
    ...
    try {
      ...
      switch (error.code) {
        case error.PERMISSION_DENIED:
          setError('Permesso negato. La geolocalizzazione è necessaria per trovare altri cani nelle vicinanze.');
          break;
        case error.POSITION_UNAVAILABLE:
          setError('Posizione non disponibile. Controlla le impostazioni del dispositivo.');
          break;
        case error.TIMEOUT:
      ...
      <div className="mt-10 text-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500 mt-4">
            I tuoi dati di posizione sono protetti e utilizzati solo per il matching.
          </p>
        </div>
      </div>
